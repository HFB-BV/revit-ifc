...
namespace BIM.IFC.Export.UI
{
   ...
   public class IFCCommandOverrideApplication : IExternalApplication
   {
      ...
      private static IFCExportFailuresContainer PerformLinkedExports(Autodesk.Revit.DB.Document document, string folderpath, string fileName, Dictionary<ElementId, string> linksGUIDsCache, IFCExportOptions exportOptions)
      {
         // get the extension
